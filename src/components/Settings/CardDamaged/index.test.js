...
import CardDamaged from './index';

const history = createMemoryHistory();
window.Intercom = jest.fn();

describe('CardDamaged without AppContext', () => {
  beforeEach(() => {
    render(
  ...
  test('should have correct text', () => {
    expect(
      screen.queryAllByText(
        'We’ll deactivate your lost debit card, give you a new card number, and mail you a new debit card.'
      )
    ).toHaveLength(1);
  });
});

describe('CardDamaged with AppContext', () => {
