...
import stolenIco from '../../../assets/img/stolen-ico.svg';
  ...
  try {
    ...
    return (
      <div className={classes.wrapper}>
        ...
        <img src={stolenIco} alt="" className={classes.icon} />
        <Typography className={classes.text}>
          We’ll deactivate your stolen debit card, give you a new card number,
          and mail you a new debit card.
        </Typography>
...
CardStolen.defaultProps = {
  userData: undefined,
  closeReport: undefined
};

CardStolen.propTypes = {
